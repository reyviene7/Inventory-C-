namespace ServeAll.Core.Queries
{
    public class Query
    {
        ...
        public const string SelectReportWareHouseItem = "SELECT delivery_id, product_name, quantity_in_stock, delivery_code, branch_details, last_cost_per_unit, retail_price, delivery_date, status_details FROM report_warehouse_item";
