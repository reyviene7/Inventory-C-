...
namespace Inventory.Config
{
    public static class ReportSetting
    {
        ...
        public static void ListofDailyExpenses(string fullName)
        {
            var report = new RepDailyExpenses();
            var serv = new ServDailyExpenses();
            var dataSource = serv.DataSource();
            report.Load(dataSource);
            var prePared = new XRLabel
            {
        ...
        public static void ListofServiceParticular(string fullName)
        {
            var report = new RepServiceParticular();
            var serv = new ServServiceParticular();
            var dataSource = serv.DataSource();
            report.Load(dataSource);
            var prePared = new XRLabel
            {
